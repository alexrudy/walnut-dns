...
use crate::serialize::text::Token;
use crate::{error::ProtocolError, rr::RecordType, serialize::binary::DecodeError};
...
pub enum ParseError {
    ...
    DataEncoding(#[source] data_encoding::DecodeError),
...
impl From<DecodeError> for ParseError {
    fn from(e: DecodeError) -> Self {
        Self::from(ProtocolError::from(e))
    }
}
